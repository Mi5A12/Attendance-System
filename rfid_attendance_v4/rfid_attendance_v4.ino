...
const char *GScriptId = "AKfycbyd_yhUmaaOHVrTl3pexTGFgT8W9DASbEPntgt8PnL3P_vBVjn69NLxW6Vp0Kpsa-aH";
String gate_number = "Gate1";
//---------------------------------------------------------------------------------------------------------
// Enter network credentials:
const char* ssid     = "MUN Inc.";
const char* password = "SDGs_2030";
//---------------------------------------------------------------------------------------------------------
...
void loop() {
  ...
  if(client->POST(url, host, payload)){ 
    ...
    lcd.clear();
    lcd.setCursor(0,0); //col=0 row=0
    lcd.print("Thank You!: "+student_id);
    //lcd.setCursor(0,1); //col=0 row=0
    //lcd.print("Thanks");
  }
  //----------------------------------------------------------------
